...
```console
curl -X POST localhost:3004/catalog/addProduct -H "Content-Type: application/json" -d '{"userRole": "admin","productImage":"url",""productName": "salad", "productCat": "vegetables"}'
